...
export async function GET(
  ...
  try {
    ...
    const userPrefs = await getUserBySpotifyId(spotifyId)

    if (!userPrefs || !userPrefs.privacySettings.isPublic || userPrefs.privacySettings.hideSpotifyId) {
    ...
    // Filter data based on user preferences (same as slug route)
